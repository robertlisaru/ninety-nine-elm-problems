...
var $author$project$Main$Model = F4(
	function (p1List, problems, p1input, p1showCode) {
		return {p1List: p1List, p1input: p1input, p1showCode: p1showCode, problems: problems};
	});
var $author$project$Main$P1RandomListReady = function (a) {
	return {$: 'P1RandomListReady', a: a};
};
...
var $author$project$Main$initProblems = _List_fromArray(
	[
...
var $author$project$Utils$listToString = F3(
	function (convert, separator, list) {
		return '[' + (A2(
			$elm$core$String$join,
			separator,
			A2($elm$core$List$map, convert, list)) + ']');
	});
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'P1RequestRandomList':
				return _Utils_Tuple2(
					model,
					A2(
						$elm$random$Random$generate,
						$author$project$Main$P1RandomListReady,
						A2(
							$elm$random$Random$list,
							10,
							A2($elm$random$Random$int, 1, 100))));
			case 'P1RandomListReady':
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							p1List: randomList,
							p1input: A3($author$project$Utils$listToString, $elm$core$String$fromInt, ', ', randomList)
						}),
			...
			case 'P1InputBlur':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							p1input: A3($author$project$Utils$listToString, $elm$core$String$fromInt, ', ', model.p1List)
						}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
...
var $author$project$Styles$problemListStyles = _List_fromArray(
	[
...
var $author$project$Main$P1InputBlur = {$: 'P1InputBlur'};
var $author$project$Main$P1InputUpdate = function (a) {
	return {$: 'P1InputUpdate', a: a};
};
var $author$project$Main$P1RequestRandomList = {$: 'P1RequestRandomList'};
var $author$project$Main$P1ShowCodeToggle = {$: 'P1ShowCodeToggle'};
...
var $author$project$Styles$codeStyles = _List_fromArray(
	[
		$rtfeldman$elm_css$Css$backgroundColor(
		$rtfeldman$elm_css$Css$hex('#f6f8fa')),
		A2(
...
var $author$project$Utils$displayIf = F2(
	function (shouldDisplay, element) {
		return shouldDisplay ? element : $rtfeldman$elm_css$Html$Styled$text('');
	});
...
var $author$project$Solutions$P1LastElement$last = function (xs) {
...
var $author$project$Utils$maybeToString = F2(
	function (convert, maybe) {
		return A2(
			$elm$core$Maybe$withDefault,
			'Nothing',
			A2(
...
var $author$project$Styles$problemStyles = _List_fromArray(
	[
		...
		$rtfeldman$elm_css$Css$px(0)),
		$rtfeldman$elm_css$Css$backgroundColor(
		A3($rtfeldman$elm_css$Css$rgb, 200, 255, 255))
	]);
var $author$project$Styles$syntaxHighlightRequiredRawCss = '\n/* Elm Syntax Highlight CSS */\npre.elmsh {\n  padding: 10px;\n  margin: 0;\n  text-align: left;\n  overflow: auto;\n  border-radius: 5px;\n  background-color: #ffffff;\n}\n\ncode.elmsh {\n  padding: 0;\n}\n\n.elmsh-line:before {\n  content: attr(data-elmsh-lc);\n  display: inline-block;\n  text-align: right;\n  width: 40px;\n  padding: 0 20px 0 0;\n  opacity: 0.3;\n}\n\n';
var $author$project$Styles$syntaxHighlightRequiredCssNode = A3(
	$rtfeldman$elm_css$Html$Styled$node,
	'style',
	_List_Nil,
	_List_fromArray(
		[
			$rtfeldman$elm_css$Html$Styled$text($author$project$Styles$syntaxHighlightRequiredRawCss)
		]));
var $author$project$Styles$syntaxHighlightThemeRawCss = '\n.elmsh {\n    color: #24292e;\n    background: #ffffff;\n}\n.elmsh-hl {\n    background: #fffbdd;\n}\n.elmsh-add {\n    background: #eaffea;\n}\n.elmsh-del {\n    background: #ffecec;\n}\n.elmsh-comm {\n    color: #969896;\n}\n.elmsh1 {\n    color: #005cc5;\n}\n.elmsh2 {\n    color: #df5000;\n}\n.elmsh3 {\n    color: #d73a49;\n}\n.elmsh4 {\n    color: #0086b3;\n}\n.elmsh5 {\n    color: #63a35c;\n}\n.elmsh6 {\n    color: #005cc5;\n}\n.elmsh7 {\n    color: #795da3;\n}\n.elmsh-elm-ts, .elmsh-js-dk, .elmsh-css-p {\n    font-style: italic;\n    color: #66d9ef;\n}\n.elmsh-js-ce {\n    font-style: italic;\n    color: #a6e22e;\n}\n.elmsh-css-ar-i {\n    font-weight: bold;\n    color: #f92672;\n}\n';
var $author$project$Styles$syntaxHighlightThemeCssNode = A3(
	$rtfeldman$elm_css$Html$Styled$node,
	'style',
	_List_Nil,
	_List_fromArray(
		[
			$rtfeldman$elm_css$Html$Styled$text($author$project$Styles$syntaxHighlightThemeRawCss)
		]));
	...
	function (model, _v0) {
		...
		if (number === 1) {
			return A2(
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Styles$problemStyles)
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text('Write a function '),
								A2(
								$rtfeldman$elm_css$Html$Styled$code,
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Styles$codeStyles)
									]),
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$text('last')
									])),
								$rtfeldman$elm_css$Html$Styled$text(' that returns the last element of a list. An empty list doesn\'t have a last element, therefore '),
								A2(
								$rtfeldman$elm_css$Html$Styled$code,
								_List_fromArray(
									[
								...
								$rtfeldman$elm_css$Html$Styled$text(' must return a '),
								A2(
								$rtfeldman$elm_css$Html$Styled$code,
								_List_fromArray(
									[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$text('Input list: ')
									])),
								A2(
								...
								_List_fromArray(
									[
										...
										$rtfeldman$elm_css$Html$Styled$Events$onInput($author$project$Main$P1InputUpdate),
										$rtfeldman$elm_css$Html$Styled$Events$onBlur($author$project$Main$P1InputBlur),
										$rtfeldman$elm_css$Html$Styled$Attributes$value(model.p1input)
									]),
								_List_Nil),
								A2(
								...
								_List_fromArray(
									[
										...
										$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$Main$P1RequestRandomList)
									]),
								_List_fromArray(
									[
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text('Last element is: ')
							])),
						A2(
						$rtfeldman$elm_css$Html$Styled$code,
						_List_fromArray(
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text(
								A2(
									$author$project$Utils$maybeToString,
									$elm$core$String$fromInt,
									$author$project$Solutions$P1LastElement$last(model.p1List)))
							])),
						A2(
						$rtfeldman$elm_css$Html$Styled$button,
						_List_fromArray(
							[
								...
								$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$Main$P1ShowCodeToggle)
							]),
						_List_fromArray(
							[
								model.p1showCode ? $rtfeldman$elm_css$Html$Styled$text('Hide code') : $rtfeldman$elm_css$Html$Styled$text('Show code (spoiler)')
							])),
						A2(
						$author$project$Utils$displayIf,
						model.p1showCode,
						function () {
							var codeString = 'import List\n\n\nlast : List a -> Maybe a\nlast xs =\n    xs\n        |> List.reverse\n        |> List.head\n';
							return A2(
								$rtfeldman$elm_css$Html$Styled$div,
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										$author$project$Styles$syntaxHighlightRequiredCssNode,
										$author$project$Styles$syntaxHighlightThemeCssNode,
										...
										A2(
											...
											_List_fromArray(
												[
													$rtfeldman$elm_css$Html$Styled$text(codeString)
												])),
										A2(
											$elm$core$Result$map,
											$rtfeldman$elm_css$Html$Styled$fromUnstyled,
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text('Problem requirement here.')
							]))
					]));
		}
	});
		...
		body: A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Styles$problemListStyles)
						]),
					A2(
						$elm$core$List$map,
						$author$project$Main$viewProblem(model),
						model.problems))
				])),
...
var $author$project$Main$main = $elm$browser$Browser$document(
	{
		init: $elm$core$Basics$always(
			_Utils_Tuple2(
				A4($author$project$Main$Model, _List_Nil, $author$project$Main$initProblems, '[]', false),
				A2(
					$elm$random$Random$generate,
					$author$project$Main$P1RandomListReady,
					A2(
